...
type TeamStore interface {
	...
	SearchAllPaged(term string, page int, perPage int) ([]*model.Team, int64, error)
...
type PostStore interface {
	...
	SearchPostsInTeamForUser(paramsList []*model.SearchParams, userId, teamId string, isOrSearch, includeDeletedChannels bool, page, perPage int) (*model.PostSearchResults, error)
