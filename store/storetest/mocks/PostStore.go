...
func (_m *PostStore) SearchPostsInTeamForUser(paramsList []*model.SearchParams, userId string, teamId string, isOrSearch bool, includeDeletedChannels bool, page int, perPage int) (*model.PostSearchResults, error) {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func([]*model.SearchParams, string, string, bool, bool, int, int) error); ok {
